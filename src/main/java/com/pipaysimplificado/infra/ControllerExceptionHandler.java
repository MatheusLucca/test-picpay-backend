package com.pipaysimplificado.infra;

import com.pipaysimplificado.dtos.ExceptionDTO;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity threatDuplicateEntryException(DataIntegrityViolationException ex) {
